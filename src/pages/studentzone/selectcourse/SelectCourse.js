    ...
    if (enrollment === "" || pass === "") {
      ...
      try {
        ...
        const response = await axios({
          method: "post",
          url: "https://backend.ignti.in/api/students/verify-student",
          data: {
        ...
        if (response.data.success) {
          const result = await axios({
            method: "post",
            url: "https://backend.ignti.in/api/courses/verify-password",
            data: {
              courseName: selectedCategory,
              password: pass,
            },
          ...
          if (result.data.success) {
            ...
            const response1 = await axios({
              method: "post",
              url: "https://backend.ignti.in/api/subjects/get-subject",
              data: {
                courseName: selectedCategory,
                semesterNumber: num,
              },
                ...
                if (response2.data.data.authorized) {
                  const promises = response1.data.data1.map(async (subject) => {
                    ...
                    const result1 = await axios({
                      method: "post",
                      url: "https://backend.ignti.in/api/resultSets/get-result-set",
                      data: {
                        courseName: selectedCategory,
                        semesterNumber: num,
